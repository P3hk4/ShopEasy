...
public class MapperDTO {
    ...
    public base.DTO.ClientDTO entityToDTO(Client client) {
        return new base.DTO.ClientDTO(client.getClientId(),client.getUsername(),client.getEmail(),client.getFirstName(),client.getLastName());
    }
