...
import base.DataGenerationScrypt.StringsSplitter;
import base.Entity.*;
...
public class DataGenerator {
    ...
    private StringsReaderAndWriter reader;

    public ArrayList<Category> generateCategories(){
        ArrayList<Category> categories = new ArrayList<>();
        ArrayList<String> strings = readStringsFromFile("/Data/Categories.txt");
    ...
    public ArrayList<Manufacturer> generateManufacturers(){
        ...
        ArrayList<String> strings = readStringsFromFile("/Data/Manufacturers.txt");
    ...
    public ArrayList<Client> generateClients(){
        ...
        ArrayList<String> emails = readStringsFromFile("/Data/Emails.txt");
        ArrayList<String> maleNames = readStringsFromFile("/Data/MaleNames.txt");
        ArrayList<String> femaleNames = readStringsFromFile("/Data/FemaleNames.txt");
        ArrayList<String> maleLastNames = readStringsFromFile("/Data/MaleLastnames.txt");
        ArrayList<String> femaleLastNames = readStringsFromFile("/Data/FemaleLastnames.txt");
    ...
    public ArrayList<Shipping> generateShippings(List<Integer> clientIds){
        ...
        ArrayList<String> cities = readStringsFromFile("/Data/Cities.txt");
        ArrayList<String> addresses = readStringsFromFile("/Data/Addresses.txt");
